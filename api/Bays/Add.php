...
{
  if(isset($_POST['Username'], $_POST['Password'], $_POST['Name'], $_POST['Temp'], $_POST['Status'])) {
    $pm->PM_AddNewBayToSite_API($_POST['Username'], $_POST['Password'], $_POST['Name'], $_POST['Temp'], $_POST['Status']);
  } else {
