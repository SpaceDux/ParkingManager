        ...
        <form id="PaymentPane_Form">
          <div class="row">
            <div class="col">
              ...
              <input type="text" name="Payment_Plate" class="form-control" placeholder="E.G CY15GHX" style="text-transform: uppercase;">
              <hr>
            ...
            <div class="col">
              ...
              <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  ...
                  <a class="nav-item nav-link disabled" id="nav-snap-tab" data-toggle="tab" href="#nav-snap" role="tab" aria-controls="nav-snap" aria-selected="false"><i class="fas fa-times-circle" style="color: red;"></i> SNAP</a>
