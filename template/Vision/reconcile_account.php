          ...
          <div class="jumbotron">
            ...
            <form action="{URL}/download_report.php" method="post">
              <div class="row">
                ...
                <div class="col-md-2">
                  <input type="text" class="form-control" placeholder="Date Too" name="Report_DateToo" id="Report_DateToo" value="<?php echo date("Y-m-07"); ?>" required>
                </div>
                <div class="col-md-2">
                  <div class="btn-group dropdown">
                    <button type="button" id="Account_Reconcile" class="btn btn-primary">Generate</button>
                  </div>
                </div>
              </div>
            </form>
