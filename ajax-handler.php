<?php
  ...
  if($handler == "exit") { //Exit Vehicle from PM
    ...
    $payment->Payment_Service_Update($_POST['Service_ID'], $_POST['Service_Name'], $_POST['Service_Ticket'], $_POST['Service_Price_Gross'], $_POST['Service_Price_Net'], $_POST['Service_Expiry'], $_POST['Service_Cash'], $_POST['Service_Card'], $_POST['Service_Account'], $_POST['Service_Snap'], $_POST['Service_Fuel'], $_POST['Service_Campus'], $_POST['Service_Vehicles'], $_POST['Service_Meal_Amount'], $_POST['Service_Shower_Amount'], $_POST['Service_Any'], $_POST['Service_Group'], $_POST['Service_ETPID']);
    ...
    $payment->Transaction_Proccess_Fuel($_POST['ANPRKey'], $_POST['Plate'], $_POST['Company'], $_POST['Trailer'], $_POST['Vehicle_Type'], $_POST['Service'], $_POST['FuelCardNo'], $_POST['CardExpiry']);
    ...
    $payment->Transaction_Proccess_Fuel_Renewal($_POST['LogID'], $_POST['ANPRKey'], $_POST['PayRef'], $_POST['Plate'], $_POST['Company'], $_POST['Trailer'], $_POST['Vehicle_Type'], $_POST['Service'], $_POST['Expiry'], $_POST['FuelCardNo'], $_POST['CardExpiry']);
    ...
    $account->Account_PaymentService_Switch($_POST['Payment_ID'], $_POST['NT_Payment_Service_Account']);
  }
