  ...
  $(document).ready(function() {
    $.ajax({
      ...
      success:function(Response) {
        if(Response.Code == "0" && "<?php if(isset($_GET['page'])){echo $_GET['page'];} ?>" != "index") {
          document.location.replace("{URL}/index");
        } else if(Response.Code == "1" && "<?php if(isset($_GET['page'])){echo $_GET['page'];} ?>" == "index") {
