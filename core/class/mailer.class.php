  ...
  class Mailer
  {
    ...
    function SendActivation($Too)
    {
      ...
      try {
        ...
        $mail->Host       = "mail.rktruckstops.co.uk";
        $mail->SMTPAuth   = true;
        $mail->Username   = 'no-reply@rktruckstops.co.uk';              // SMTP username
        ...
        $mail->Body = file_get_contents($_SERVER['DOCUMENT_ROOT'].'/ParkingManager/email_templates/activation.html');
