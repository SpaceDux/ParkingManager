<?php
  ...
  class Account
  {
    ...
    function New_Account($Name, $Short, $Address, $Contact, $Billing, $Site, $Shared, $Discount, $Status)
    {
      $this->mysql = new MySQL;

      $Uniqueref = date("YmdHis").mt_rand(1111, 9999).$Site;

      $stmt = $this->mysql->dbc->prepare("INSERT INTO accounts (id, Uniqueref, Site, Shared, Name, ShortName, Address, Contact_No, Billing_Email, Discount_Vouchers, Status, Last_Updated) VALUE ('', ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
